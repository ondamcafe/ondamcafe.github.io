...
.theme-switch {
  ...
  --transition: .6s cubic-bezier(0, -0.02, 0.4, 1.25);
  --circle-transition: .2s cubic-bezier(0, -0.02, 0.35, 1.17);
}
...
.theme-switch__container {
  ...
  cursor: pointer;
  outline: none;
  -webkit-box-shadow: 0em -0.01em 0.01em rgb(0, 0, 0), 0em 0.1em 0.2em rgb(92, 92, 92);
  box-shadow: 0em -0.062em 0.062em rgba(0, 0, 0, 0.45), 0em 0.1em 0.2em rgb(190, 190, 190);
...
.theme-switch__container::before {
  ...
  z-index: 1;
  inset: 0;
  -webkit-box-shadow: 0em 0.05em 0.187em rgb(0, 0, 0) inset, 0em 0.05em 0.187em rgb(141, 141, 141) inset;
  box-shadow: 0em 0.3em 0.4em rgb(37, 37, 37) inset, 0em 0.1em 0.2em rgb(161, 161, 161) inset;
  border-radius: var(--container-radius)
}
...
.theme-switch__sun-moon-container {
  ...
  -webkit-box-shadow: 0.062em 0.062em 0.062em 0em rgba(0, 0, 0, 0.61) inset, 0em -0.062em 0.062em 0em #a1872a inset;
...
const SearchBar = styled.div`
  ...
  input {
    ...
    &:focus {
      background-color: ${({theme}) => theme.SearchBar.input.focus.background};
...
const CategoryItem = styled.button`
  ...
  &:hover {
    ...
    svg {
      color: ${({theme, selected}) =>
    selected ? theme.Category.hover.svg.colorN : theme.Category.hover.svg.colorS};
    }
  }
  img {
    ...
    <ThemeProvider theme={darkMode ? darkTheme : lightTheme}>
      ...
      <Container>
          ...
          <div class="card">
            ...
            <ThemeToggle >
                <label class="theme-switch">
                  <input type="checkbox" class="theme-switch__checkbox" onClick={() => setDarkMode(!darkMode)}/>
        ...
        <CategoryTitle role="heading" aria-level={2}>
          {(() => {
          const cat = categoriesData.find((cat) => cat.id === selectedCategory);
          if (!cat) return null;
            return typeof cat.icon === 'function' ? cat.icon(darkMode) : cat.icon;
          })()} 
      ...
      {showSplash && (
        <SplashOverlay onClick={() => setShowSplash(false)}>
          <div class="card">
            ...
            <div class="content">
              <h3>خوش آمدید :)</h3>
              <p>در ساعات شلوغ، زمان میزبانی از هر میز حداکثر ۱ ساعت و نیم میباشد</p>
